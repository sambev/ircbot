def currentWeather(city, state):
    ...
    r = requests.get('http://api.openweathermap.org/data/2.5/weather?q=Provo,Ut')
    ...
    weather['rain'] = '%smm' % data['rain']['3h']
    weather['clouds'] = '%s percent' % data['clouds']['all']
